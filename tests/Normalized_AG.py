...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  4 12:26:25 2023
...
simulation_parameters = {'slow_time' : 0.02*nn, #numper of photonliferimes per whole simlulation region
                         'detuning_array' : dOm,
...
seed = single_ring.seed_soliton(Pump,dOm[0],Normalized_Units=True)
...
map2d = single_ring.Propagate_SplitStep(simulation_parameters, Pump,Seed=seed,dt=0.5e-4,HardSeed=True,Normalized_Units=True)
#%%
plt.figure()
